...
public class Java8Tester {
    ...
    public static void main(String args[]) {
        ...
        List<String> strs = strings.stream().filter(s -> !s.isEmpty()).collect(Collectors.toList());
        System.out.println("List8: " +strings);
        ...
        List<String> c = strings.stream().filter(s -> !s.isEmpty()).collect(Collectors.toList());
